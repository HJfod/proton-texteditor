...
b_fs = tk.Button(root, text='✕', font=('Roboto Lt',12,'normal'), border=0, padx=5, pady=20, fg="#fff", bg="#0a0a0a", activebackground='#f00', activeforeground='#fff', command=root.quit)
